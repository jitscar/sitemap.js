 ...
 * @param   {String}        conf.hostname
 * @param   {Number}        conf.cacheTime
 * @param   {String}        conf.sitemapFolder
 ...
 * @param {String}        sitemapFolder optional
 ...
 */
function SitemapIndex(urls, targetFolder, hostname, cacheTime, sitemapName, sitemapFolder, sitemapSize, xslUrl, gzip, callback) {
  ...
  self.sitemapFolder = sitemapFolder;
  ...
  self.chunks.forEach(function (chunk, index) {
    ...
    if (self.sitemapFolder) {
      filename = self.sitemapFolder + '/' + filename;
    }
