 ...
 * @param {String}        chunkFolder   optional
 ...
 */
function SitemapIndex(urls, targetFolder, hostname, cacheTime, chunkFolder, sitemapName, sitemapSize, xslUrl, gzip, callback) {
  ...
  self.chunks.forEach(function (chunk, index) {
    ...
    console.log('chunks!!! ' + self.chunkFolder)

    if (self.chunkFolder) {
      console.log('chunkFolder exists!');
      filename = self.chunkFolder + '/' + filename;
    }
